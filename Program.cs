    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                for (int y = 0; y < 5; y++)
                {
                Thread.Sleep(credits.Milliseconds + 10);
                Console.Write(".");
                Thread.Sleep(credits.Milliseconds + 20);
                Console.Write(".");
                Thread.Sleep(credits.Milliseconds + 5);
                Console.Write(".");
            ...
            while (true)
            {
                ...
                while (mainMenu == true)
                {
                    ...
                    while (Menu == true)
                    {
                        ...
                        try
                        {
                            Console.WriteLine("FHackerMan version.4.0.0");
                            ...
                            Console.WriteLine("3 - Load last updated settings");
                            if (loaded == true)
                            {
